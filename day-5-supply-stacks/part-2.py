...
for move_num, source_id, dest_id in moves:
    stack_len = len(stacks[source_id]) - move_num
    keep, move = stacks[source_id][:stack_len], stacks[source_id][stack_len:]
    stacks[source_id] = keep
    stacks[dest_id] = stacks[dest_id] + move
